package com.scrappyz.ytdlp.download.api.controller;
...
import com.scrappyz.ytdlp.download.api.dto.DownloadCancelResponse;
...
public class DownloadController {
    ...
    public ResponseEntity<FileSystemResource> getResource(@PathVariable String requestId,
        @RequestParam(name = "output", required = false, defaultValue = "") String outputName) throws InvalidUlidException {
    ...
    public ResponseEntity<DownloadCancelResponse> cancelDownload(@PathVariable String requestId) throws InvalidUlidException {
